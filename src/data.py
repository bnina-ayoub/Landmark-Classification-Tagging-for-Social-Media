...
def get_data_loaders(
    ...
    data_transforms = {
        "train": transforms.Compose(
                   [
                       ...
                       transforms.RandAugment(3, 15, interpolation = transforms.InterpolationMode.BILINEAR),
                       transforms.ToTensor(),
    ...
    train_data = datasets.ImageFolder(
        base_path / "train",
        transform = data_transforms["train"]    #add the appropriate transform that you defined in
